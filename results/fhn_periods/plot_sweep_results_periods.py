...
result_file = "results/fhn_periods/results_20250609_121339.pkl"
...
plt.ylim(-0.1, 1.1)
#plt.xlim(-0.05, 0.65)
plt.savefig("results/fhn_periods/periods_diff.png", dpi=180)
plt.show()
...
plt.xscale('log')
#plt.xlim(, 3.5)
plt.savefig("results/fhn_periods/periods_diff_lim.png", dpi=180)
plt.show()