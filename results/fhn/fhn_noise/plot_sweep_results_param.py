...
result_file = "results/fhn/fhn_noise/results_20250609_121859.pkl"
...
plt.ylim(-0.1, 1.1)
#plt.xlim(-0.05, 0.65)
plt.savefig("results/fhn/fhn_noise/noise_diff.png", dpi=180)
plt.show()
...
#plt.xscale('log')
plt.xlim(-0.05, 0.3)
plt.savefig("results/fhn/fhn_noise/noise_diff_lim.png", dpi=180)
plt.show()
