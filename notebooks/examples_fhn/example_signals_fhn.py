...
plt.savefig('notebooks/example_signals_fhn_obs_class0.png', dpi=300)
#plt.show()
...
plt.xlabel("Time [a.u]")
plt.savefig('notebooks/example_signals_fhn_obs_class1.png', dpi=300)
#plt.show()
...
plt.savefig('notebooks/example_signals_fhn_obs_single.png', dpi=300)
plt.show()
